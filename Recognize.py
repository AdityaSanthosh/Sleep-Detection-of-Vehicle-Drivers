    ...
    while True:
        ...
        for face_landmark in face_landmarks_list:
            ...
            for (top, right, bottom, left), face_encoding in zip(current_face_locations, current_face_encodings):
                ...
                bottom *= 4
                left *= 4
                if eyes_closed_time > 4:
                    # Draw a Rectangle around the Face
                    cv2.rectangle(frame, (left, top), (right, bottom), (0, 0, 255), 2)
                    cv2.rectangle(frame, (left, bottom - 35), (right, bottom), (0, 0, 255), cv2.FILLED)
                    font = cv2.FONT_HERSHEY_DUPLEX
                    cv2.putText(frame, "Sleeping", (left + 6, bottom - 6), font, 1.0, (255, 255, 255), 1)
                if eyes_closed_time < 4:
                    # Draw a Rectangle around the Face
                    cv2.rectangle(frame, (left, top), (right, bottom), (0, 0, 255), 2)
                    cv2.rectangle(frame, (left, bottom - 35), (right, bottom), (0, 0, 255), cv2.FILLED)
                    font = cv2.FONT_HERSHEY_DUPLEX
                    cv2.putText(frame, "Not Sleeping", (left + 6, bottom - 6), font, 1.0, (255, 255, 255), 1)
